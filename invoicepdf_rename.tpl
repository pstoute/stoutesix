...
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * 
 * Multibrand Integration
 */
use MGModule\Multibrand\Core\Whmcs\Invoices\Invoice;
use MGModule\Multibrand\Core\Helpers\ClientAreaHelper;
 
//load Multibrand
require ROOTDIR.'/modules/addons/Multibrand/Loader.php';
new MGModule\Multibrand\Loader();
MGModule\Multibrand\Addon::I();
...
//Set brand logo - to make less changes in whole file we will use relative path
$brand = $invoice->getBrand();
$customLogo = "../../" . $brand->logo->getPath() . $brand->logo->filename;

//Set company address
$companyaddress = explode("\n",$brand->settings->payToText);
/* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
